...
typedef struct {
    ...
    uint8_t wurzelzaehler,ladeschwelle, ladeende,ladeende2,  AWtest,aWATTar,wbmaxladestrom,wrsteuerung,stop,test;
    int32_t ht, unload,untererLadekorridor, obererLadekorridor, minimumLadeleistung, maximumLadeleistung, wrleistung,peakshave,peakshavesoc,wbmode,wbminlade,wbhour,wbvon,wbbis;
