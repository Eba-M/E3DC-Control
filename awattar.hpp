...
typedef struct {
    ...
    WPHeizlast,WPHeizgrenze,WPNat,WPLeistung,WPmin,WPmax,WPPVon,WPPVoff,WPEHZ,WPZWE,WPZWEPVon,WPHK1,WPHK1max,WPHK2on,WPHK2off,WPOffset,BWWPein,BWWPaus,BWWPon,BWWPoff,BWWPmax, BWWPSupport,BWWPTasmotaDauer,ForcecastSoc,ForcecastConsumption,ForcecastReserve;
