...
typedef struct {
    ...
    char analyse[128];
    bool ext1,ext2,ext3,ext4,ext7,debug,debug1,htsat,htsun,openWB,shelly0V10V,tasmota,WP,WPWolf,WPIDM,WPSperre,DCDC,openmeteo,statistik,prognosetest;
    ...
    float_t RB,RE,LE,speichergroesse,speichereta,speicherev,winterminimum, sommermaximum,sommerladeende, einspeiselimit,powerfaktor,peakshavesoc,ladeende2rampe,DVmp,DVcarlimit,
...
static float fatemp,fatemp24,fatemp48,fcop;
