...
// bei Direktvermarktung ist der wärmepreis der Börsenpreis + Marktprämie
                                    ...
                                    else
                                    {
                                        if (fsoc*e3dc.speichereta-e3dc.AWReserve-notstromreserve>0)
                                        {
                                            ...
                                            {
                                                int h1,l1;
                                                if (e3dc.debug) printf("NW6c %i\n",x1);
                                                if (x1<e.size()&&SucheDiff1(e, w, e[x1].pp,x1, e.size(),e3dc, h1, l1))
                                                {
                                                    if (h1<=l1)
                                                        wet.waermepreis = w[x1].pp*.1/wet.cop;
                                                    else // speicherpreis
                                                ...
                                                {
                                                    // in die Wärmeplanung die Bezugspreise des nächsten Tag einbinden
                                                    
                                                    
                                                    if (x1<e.size()&&SucheDiff1(w, w, e[x1].pp,x1, w.size()-48,e3dc, h1, l1))
...
//                                                wet.waermepreis = (w[l1].pp*.1)/wet.cop;
                                        ...
                                        {
                                            wet.waermepreis = (highpp*.1*(100+e3dc.AWMWSt)/100+e3dc.AWNebenkosten)/wet.cop;
                                            wet.status = 0;
                                        }
                                    }
                                                ...
                                                if (leistung < av)   // Verdichterleistung erhöhen
                                                {
                                                        ...
                                                        )
                                                    {
                                                            ...
                                                            &&wetter[wetter1[0].x1].hourly+wpbedarf>wetter[wetter1[0].x1].solar)
                                                        {
                                                            ...
                                                            {
                                                                wetter1[0].status = 0;
                                                                wetter1[0].waermepreis = w[wetter1[0].x1].pp*.1/wetter1[0].cop;
                                                            }
                                                        }
                                                        if (wet.status == 2)
                                                        {
                                                    ...
                                                    if (wet.status==2)
                                                    {
                                                        if (wetter[wetter1[0].x1].heizstabbedarf>0){
                                                            if (fhighsoc[j1]>3/e3dc.speichergroesse*25)
                                                                fhighsoc[j1]=fhighsoc[j1]-3/e3dc.speichergroesse*25;
                                                            else
                                                                wetter1[0].status=1;}
                                                    }
...
*/
                                                        ...
                                                        if (wetter[wetter1[0].x1].wwwpbedarf>0) //heizstab
                                                        {
                                                            ...
                                                            {
                                                                float wpbedarf = (wetter[wetter1[0].x1].hourly+wetter[wetter1[0].x1].wpbedarf+wetter[wetter1[0].x1].wwwpbedarf+wetter[wetter1[0].x1].heizstabbedarf + 3/e3dc.speichergroesse*25);
                                                                if (wetter[wetter1[0].x1].hourly+wetter[wetter1[0].x1].wpbedarf+wetter[wetter1[0].x1].wwwpbedarf+wetter[wetter1[0].x1].heizstabbedarf + 3/e3dc.speichergroesse*25
                                                                    <wetter[wetter1[0].x1].solar)
                                                                {
                                                                    wetter[wetter1[0].x1].heizstabbedarf =
...
//                    fprintf(fp,"%5.2f %7.3f %6.3f \n",((e[j].hh%(24*3600))/3600.0),e[j].pp/10,fsoue);
                    fprintf(fp,"%5.2f %7.3f %7.3f %7.3f %7.3f %7.3f \n",((e[j].hh%(24*3600))/3600.0),e[j].pp/10,fsoue,fsoue*e3dc.speichergroesse/100.,fsoue2,fsoue2*e3dc.speichergroesse/100.);
                }
            }
            fclose(fp);
            fclose(fp1);
