    ...
    if ((e3dc_config.wbmode>0)) // Dose verriegelt, bereit zum Laden
    {
        ...
        switch (e3dc_config.wbmode)
        {
            case 1:
                ...
                iPower = -fPower_Grid-e3dc_config.einspeiselimit*1000-iRefload+iPower_Bat+iWBMinimumPower;
                // Schon 500W früher einschalten
                //                iPower = -fPower_Grid-e3dc_config.einspeiselimit*1000;
                if (fPower_WB > 100)
                {
                iPower = -fPower_Grid-e3dc_config.einspeiselimit*1000+500-iRefload+iPower_Bat+iWBMinimumPower/6;
