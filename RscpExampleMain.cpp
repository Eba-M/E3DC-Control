...
// Grid
                    if (e3dc_config.WP)
                    {
                        ...
                        int x4 = (t+900)%(24*3600)/900+2;
                        printf(" WB %0.02f %0.02f %0.02f %0.02f %0.02f",waermebedarf,float(iHeatStat[1]/3600000.0),float(iHeatStat[x4]/900000.0),float(iHeatStat[x2]/900000.0),float(iHeatStat[0])/900000.0*(900-(t%900)));
                    }
                }
                printf("%c[K\n", 27 );
